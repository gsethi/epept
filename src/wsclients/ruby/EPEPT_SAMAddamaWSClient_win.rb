...
def initialize()
  ...
  @argv_array << "{mode:'SAM',method:'PWM',gsa_method:'maxmean',nperms:'1000',resptype:'Quantitative',mail_address:'jlin212@gmail.com',ci_chk:'true',ci:'50',oopt_chk:'false',cc_chk:'false'}"
