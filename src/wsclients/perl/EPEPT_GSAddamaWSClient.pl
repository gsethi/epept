...
my $matrixFile = "/local/EPEPT/yeastdata.tsv";
my $gseaFile = "/local/EPEPT/geneset.gmt";

my $host = "http://informatics.systemsbiology.net";
my $outputPath = "./out";
my $params = "{mode:'GSEA',mail_address:'jlin212\@gmail.com',method:'PWM',ci_chk:'true',ci:'49',oopt_chk:'false',cc_chk:'false',resptype:'Quantitative',rseed:'100',gsa_method:'absmean'}";
