...
#my $gseaFile = "/local/EPEPT/geneset.gmt"; GSEA mode only
my $host = "http://informatics.systemsbiology.net";
my $outputPath = "./out";
my $params = "{mode:'SAM',mail_address:'jlin212\@gmail.com',method:'PWM',ci_chk:'true',ci:'49',oopt_chk:'false',cc_chk:'false',resptype:'Quantitative',rseed:'100'}";
my $json = new JSON;
my $obj;
my $url;
