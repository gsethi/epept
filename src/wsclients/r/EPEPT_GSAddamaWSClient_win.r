...
args = '';
args[1] = "{mode:'GSEA',mail_address:'jlin212@gmail.com',ci:'95',oopt_chk:'false',ci_chk:'true',cc_chk:'false',method:'PWM'}"
args[2] = "C:\\EPEPT\\out"
args[3] = "http://informatics.systemsbiology.net"
args[4] = "C:\\EPEPT\\data\\yeastdata.txt"
args[5] = "C:\\EPEPT\\data\\geneset.gmt"
print(args);
...
gsfile <- paste("\"filename=@", args[5], "\"", sep="");
...
epept_makerequest <- function (file_tsv, params, host, addama) {
   curlPostCommand <- paste("curl -X POST -F ", file_tsv, " -F ", gsfile, " -F JSON=", epept_params," ", host, addama_bot_path,sep="");
