...
args = '';
args[1] = "{mode:\"GSEA\",gsa_method:\"mean\",nperms:\"999\",resptype:\"Quantitative\",mail_address:\"jlin212@gmail.com\",ci:\"95\",oopt_chk:\"false\",ci_chk:\"true\",cc_chk:\"false\",method:\"PWM\"}"
args[2] = "./out"
args[3] = "http://informatics.systemsbiology.net"
args[4] = "/local/EPEPT/yeastdata.tsv"
args[5] = "/local/EPEPT/geneset.gmt"
print(args);
